...
5. Use the GitHub repository API tools to read any repository guidance or
...
6. Update `site/content/github-info.md` with accurate, relevant information
   based on the notes and fetched GitHub sources. Preserve the existing format
   and avoid unrelated changes.
7. Use the `create-pull-request` safe output to open a pull request for Mona to
